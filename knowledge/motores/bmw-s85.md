# S85 — V10 atmosférico (M5 E60 / M6)

| | |
|---|---|
| **Años** | 2005-2010 |
| **Config** | V10 5.0 L atmosférico, ~500 CV |
| **Montado en** | M5 E60, M6 E63/E64 |
| **Veredicto** | 🔴 **Evitar** salvo como capricho con presupuesto de mantenimiento aparte |
...
| Fallo | Síntoma | Confianza |
|---|---|---|
| VANOS | Ralentí irregular, pérdida de par | 🟡 [V5] |
| Actuadores de mariposa | Modo emergencia, fallo de gestión | 🟡 [V5] |

## Por qué se compra igual

Motor atmosférico de altísimo régimen, comercializado por BMW con parentesco
de Fórmula 1. Suena excepcional y es de los mejores V10 de calle que existen.
[V5] lo describe como coche de ensueño y ruina a la vez 🟡.

**Si alguien lo quiere igual:** que lo compre como segundo coche y con el
